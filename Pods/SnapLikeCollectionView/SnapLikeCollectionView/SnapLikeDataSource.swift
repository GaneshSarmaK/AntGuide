...
public class SnapLikeDataSource<Cell: UICollectionViewCell>: NSObject, UICollectionViewDelegate, UICollectionViewDataSource where Cell: SnapLikeCell {
    ...
    private var previousCell: Int = 0
    ...
    public init(collectionView: UICollectionView, cellSize: SnapLikeCellSize) {
        ...
        //NotificationCenter.default.addObserver(self, selector: #selector(arrowPressed), name: NSNotification.Name(rawValue: "ArrowPressed"), object: nil)
    }
    
    func arrowPressed(notification: Notification)
    {
        let xyz = notification.object as! Int
    }
    ...
    public func scrollViewWillEndDragging(_ scrollView: UIScrollView, withVelocity velocity: CGPoint, targetContentOffset: UnsafeMutablePointer<CGPoint>) {
        ...
        collectionView?.deselectItem(at: IndexPath(item: previousCell, section: 0), animated: false)
        if scrollVelocity == 0 {
